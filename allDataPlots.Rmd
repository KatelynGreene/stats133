...
~~~~~~~~~~~~~~
```{r eval = FALSE}
#Plots the percentage of people with a Bachelors vs. TreeCanopyCover and faceted by IncomeQuartile
...
```{r}
#Plots Arsenic concentration vs. Bachelor's degree attainment. Faceted by income quartile and urban rank.
