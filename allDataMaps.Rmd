...
treeCanopyDevelopped <- map %>% 
  ...
  addLegend("bottomright", pal = pal, values = ~coll_HS,
    title = "Ratio of higher education to lower education attainment",
    labFormat = labelFormat(), na.label = "county data missing",
    opacity = 1)

treeCanopyDevelopped

library(htmlwidgets)
saveWidget(treeCanopyDevelopped, file="treeCanopyDevelopped.html", selfcontained = FALSE)
```
