...
small_data <- all_data %>% 
  select(FIPSCode, StateFips, UrbanCode, UrbanRank, Income,Unemployment, Pollution, TreeCanopy, AvailGreenSpace, TreeCanopyCover)

#Only map California
# small_data <- small_data %>% 
#   subset(StateFips == "06"|StateFips == "08")
# 
# counties <- geo_join(countyShapefile, small_data, "GEOID", "FIPSCode", how = "inner")

#Map all coutnies in the USA
...
library(htmlwidgets)
saveWidget(urbanrank, file="urbanrank.html", selfcontained = FALSE)
```
