...
#' @Variables: UrbanRank (2013 Rural-Urban Continuum Code)(Anisha is currently making it) and Bachelors (%) 
#' @Year: 2013 Rural-Urban Continuum Codes, 2011-2015 Education Attainment

#' @return The data frame that contains the FIPSCode, UrbanCode (2013 Rural-Urban Continuum Code), LessThanHS (%), HSDiploma (%), Bachelors (%), UrbanRank. 
...
#' Source: https://www.ers.usda.gov/data-products/county-level-data-sets/county-level-data-sets-download-data.aspx
#' (Unemployment and median household income for the U.S., States, and counties, 2007-15)
#' @Year: 2015
#' @Variables: Household median income and Uemployment rate

#' @return dataframe that contains FIPSCode, Income, Unemployment and IncomeQuartile 
...
#Testing the tree_data temp file method --> Everything works as of 5/3
#tree_data2 <- GetTreeDataTEMP() 

#Join all data to prepare for visualization
all_data2<-plyr::join_all(list(every_county, edu_data, income_data, poll_data, tree_data), by='FIPSCode', type='full')
all_data<-na.omit(all_data) #COMMENT THIS OUT FOR LEAFLET MAPS (na's must be kept for these)
