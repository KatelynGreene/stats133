...
small_data <- all_data %>% 
  select(FIPSCode,  `2013 Urban Influence Code`, Median_Household_Income_2015,Unemployment_rate_2015, Value, TreeCanopy, AvailGreenSpace, TreeCanopyCover)

colnames(small_data) <- c("FIPSCode", "UrbanInfluence2013", "HouseholdIncome2015", "Unemployment2015", "Pollution", "TreeCanopy", "AvailGreenSpace", "TreeCanopyCover")
...
popup_dat2 <- paste(sep = "<br/>",
  ...
  counties$NAME, 
  "<b>Value: </b>", 
  counties$UrbanInfluence2013)

popup_dat3 <- paste(sep = "<br/>",
  "<b>County: </b>", 
  counties$NAME, 
  "<b>Value: </b>", 
  counties$HouseholdIncome2015)
...
pal2 <- colorNumeric(
  palette =  "YlGnBu",
  domain = counties$UrbanInfluence2013
)

pal3 <- colorNumeric(
  palette =  "YlGnBu",
  domain = counties$HouseholdIncome2015
)
...
map %>% 
  ...
  addPolygons(stroke = TRUE, color = "white", weight = .1, smoothFactor = 0.5, opacity = 1, 
    fillColor = ~pal2(UrbanInfluence2013), fillOpacity = 1, popup = popup_dat2, 
  ...
  # Layers control
  addLayersControl(
    baseGroups = c("Pollution", "UrbanInfluenceCodes","HouseholdIncome"),
