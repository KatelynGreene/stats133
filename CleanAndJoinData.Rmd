...
edu_data<-edu_data_unclean[, grep("201|FIPS Code|Code|Continuum", colnames(edu_data_unclean))]
...
>>>>>>> a3e0967751efd0f4911593d5e3c3b834197aab4a
head(data)
...
library(xlsx)
write.xlsx(all_data, "/Users/anishakumar/Documents/Stats 133/RStudio Files/Stats133Project/all_data.xlsx")
View(all_data)
```
